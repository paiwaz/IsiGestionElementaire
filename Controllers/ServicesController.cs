...
namespace IsiGestionElementaire.Controllers
{
    public class ServicesController : Controller
    {
        ...
        {
            return PartialView(db.Service.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Libelle,Montant,Type")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Libelle,Montant,Type")] Service service)
        {
            if (ModelState.IsValid)
            {
